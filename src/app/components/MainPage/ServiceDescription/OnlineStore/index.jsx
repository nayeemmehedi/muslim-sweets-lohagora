  ...
  return (
    <div className={inter.className}>
      <div className="text-white backgroundColorMain py-4">
        ...
        <div className="grid grid-cols-4   ml-auto mr-auto cursor-not-allowed	">
          {value?.map((v, key) => (
            <div className=" mx-4 rounded-lg overflow-hidden shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl bg-white my-3 border-3 ">
            {/* Image Section */}
            ...
            <div className="p-6">
              ...
              <div className="text-2xl  text-center font-semibold text-red-600">$15</div>
